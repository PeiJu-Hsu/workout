...
export const BodyComponent: React.FC<BodyComponentProps> = ({
  ...
  const onClickSvg: MouseEventHandler = (event): void => {
    ...
    // setItemGroup(target.dataset.itemGroup || "YES");
  };
  ...
  const svgElements = {
    ...
    // back: function stomach(selected: boolean): JSX.Element {
    //   return (
    //     <svg
    //       onClick={onClickSvg}
    //       data-position="stomach"
